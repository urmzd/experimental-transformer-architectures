...
- [ ] Find where it breaks: rank 256+, and apply the width lever to v12/v14 (does the law generalize across architectures?). Diminishing returns are visible (−0.30/−0.17/−0.11) — extrapolate the bpb-vs-params and coverage-vs-params curves.
